                    ...
                    <View style={styles.form}>
                        <KeyboardAvoidingView enabled>
                            ...
                            <Input
                                ...
                                rightIcon={<ViewIcon onPress={() => { this.changeSecure() }} />}
                            />
                        </KeyboardAvoidingView>
                        ...
                        <Button style={styles.btnLogin} onPress={() => this.login()}>
                            ...
                            {this.state.isLogin ?
                                ...
                                :
                                <Ionicons name={I18nManager.isRTL ? "chevron-back-outline" : "chevron-forward-outline"} size={20} color='#fff' />
                            }
                        </Button>
                    </View>
                    <Modal style={styles.modal} show={this.state.showModal} hide={() => this.setState({ showModal: false })}>
                        <APIURLForm />
                    </Modal>
                </ScrollView>
            </SafeAreaView>
