        ...
        <View style={styles.body}>
          <View style={styles.row}>
            ...
            <View style={styles.group}>
              ...
              <Text style={styles.info}>{item.spec}</Text>
            </View>
          </View>
          <View style={styles.row}>
            <View style={styles.group}>
              <Text style={styles.title}>{translate("quantity")}:</Text>
              <Text style={styles.info}>{item.qty}</Text>
            </View>
            <View style={styles.group}>
              <Text style={styles.title}>{translate("unit")}:</Text>
              <Text style={styles.info}>{item.unit}</Text>
            </View>
          </View>
          ...
          (
            <View style={styles.row}>
              <View style={styles.group}>
                ...
                <Text style={styles.info}>{item.fromWhouseName}</Text>
              </View>
              <View style={styles.group}>
                <Text style={styles.title}>{translate("toWarehouse")}:</Text>
                <Text style={styles.info}>{item.toWhouseName}</Text>
              </View>
            </View>
          )}
          <View style={styles.row}>
